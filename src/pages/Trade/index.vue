  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="user in userAddress" :key="user.id">
        ...
        <p @click="changeSelected(user, userAddress)">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img height="100px" width="100px" :src="order.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
...
export default {
  ...
  computed: {
    ...
    defaultUserAddress() {
      //数组find方法：找到适合条件的item，并且返回该item对象
      return this.userAddress.find((item) => item.isDefault == 1) || {};
    },
  },
  methods: {
    //点击改变收件人
    changeSelected(user, userAddress) {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.defaultUserAddress.consignee,//最终的用户姓名
        consigneeTel: this.defaultUserAddress.phoneNum,//最终的用户手机号
        deliveryAddress: this.defaultUserAddress.fullAddress,//最终的用户地址
